// A two pass Phong shader grabbed from Unity's reference manuals.
// This shader allows for Phong shading with a texture applied, and it uses two passes:
// One for the initial light source, and a second one to blend the other light sources in the scene.
